...
public class DemoApplication {
    ...
    public void init() {
        ...
        answerRep.save(new Answer(3, "Finally, studies show, and I know from personal experience, that employees are more loyal to and work harder for their company when they are well-treated. According to Glassdoor and other reviewers,  BHHC takes great care of their employees in terms of benefits and employee support. They also treat their employees well because they understand the importance of this in retaining good people. "));
    }
}
